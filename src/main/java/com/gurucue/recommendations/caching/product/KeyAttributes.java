...
/**
 * Key a product by an arbitrary list of attribute values.
...
public final class KeyAttributes {
    ...
    public KeyAttributes(final AttributeIds attributeIds, final String[] values) {
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof KeyAttributes)) return false;
        final KeyAttributes other = (KeyAttributes)obj;
    ...
    public static List<KeyAttributes> createKeys(final AttributeIds attributeIds, final Map<Attribute, Value> attributeValues, final AttributeCodes attributeCodes) {
        ...
        final List<KeyAttributes> result = new ArrayList<>();
        int c = 1;
        while (c >= 0) {
            ...
            result.add(new KeyAttributes(attributeIds, values));
