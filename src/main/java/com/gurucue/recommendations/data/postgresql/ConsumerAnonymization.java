...
public class ConsumerAnonymization implements TimerListener {
    private final PostgreSqlDataProvider provider;
    public final Long consumerId;
    public final long scheduledTimeMillis;

    ConsumerAnonymization(final PostgreSqlDataProvider provider, final Long consumerId, final long scheduledTimeMillis) {
    ...
    public void onTimerExpired(final long expiryTime) {
        provider.consumerAnonymizer.submit(consumerId);
    }
}
